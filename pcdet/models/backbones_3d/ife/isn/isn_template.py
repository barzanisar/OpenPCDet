#  from Depth Distribution Network template
...
class ISNTemplate(nn.Module):
    ...
    def forward(self, images):
        ...
        Returns
            result [dict[torch.Tensor]]: Image segmentation result
