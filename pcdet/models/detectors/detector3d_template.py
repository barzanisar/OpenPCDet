...
class Detector3DTemplate(nn.Module):
    def __init__(self, model_cfg, num_class, dataset):
        ...
        self.module_topology = [
            'vfe', 'ife', 'backbone_3d', 'map_to_bev_module', 'pfe',
    ...
    def post_processing(self, batch_dict, only_segmentation=False):
        """
        Args:
            batch_dict:
                batch_size:
        ...
        for index in range(batch_size):
            if not only_segmentation:
                ...
                # we are only training an image stream for segmentation
                final_scores = None
                final_labels = None
                final_boxes = None
                src_box_preds = None
    ...
    @staticmethod
    def generate_recall_record(box_preds, recall_dict, batch_index, data_dict=None, thresh_list=None, only_segmentation=False):
