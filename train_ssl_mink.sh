...
sbatch --time=10:00:00 --array=1-2%1 --job-name=det-scratch-80ep-scene100_try2 tools/scripts/submit_ddp_$CLUSTER_NAME.sh --cfg_file tools/cfgs/waymo_models/pointrcnn_minkunet_80ep_scene_sampled_100.yaml --tcp_port 19910 --extra_tag scratch_try2 
...
sbatch --time=10:00:00 --array=1-1%1 --job-name=det-scratch-80ep_try2 tools/scripts/submit_ddp_$CLUSTER_NAME.sh --cfg_file tools/cfgs/waymo_models/pointrcnn_minkunet_80ep_sampled_100.yaml --tcp_port 19911 --extra_tag scratch_try2 
...
sbatch --time=10:00:00 --array=1-3%1 --job-name=det-scratch-200ep-scene100_try2 tools/scripts/submit_ddp_$CLUSTER_NAME.sh --cfg_file tools/cfgs/waymo_models/pointrcnn_minkunet_200ep_scene_sampled_100.yaml --tcp_port 17710 --extra_tag scratch_try2
...
sbatch --time=10:00:00 --array=1-4%1 --job-name=det-scratch-200ep_try2 tools/scripts/submit_ddp_$CLUSTER_NAME.sh --cfg_file tools/cfgs/waymo_models/pointrcnn_minkunet_200ep_sampled_100.yaml --tcp_port 18811 --extra_tag scratch_try2
