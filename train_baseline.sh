...
sbatch --time=02:00:00 --gres=gpu:t4:4 --array=1-20%1 --job-name=pointrcnn-all-splits-5 tools/scripts/compute_canada_train_eval_dense.sh --cfg_file tools/cfgs/dense_models/pointrcnn_train_all_splits_60_5.yaml -tcp_port 18461 --ckpt_save_interval 20 --fix_random_seed
