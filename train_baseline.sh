...
#sbatch --time=15:00:00 --array=1-2%1 --job-name=pointrcnn-all-splits-5 tools/scripts/compute_canada_train_eval_dense.sh --cfg_file tools/cfgs/dense_models/pointrcnn_train_all_splits_60_5.yaml -tcp_port 18861 --ckpt_save_interval 20 --fix_random_seed
...
sbatch --time=05:00:00  --gres=gpu:v100:4 --array=1-3%1 --job-name=pointrcnn-all-60-1 tools/scripts/compute_canada_train_eval_dense.sh --cfg_file tools/cfgs/dense_models/pointrcnn_train_all_60_1.yaml -tcp_port 18860 --ckpt_save_interval 1 --fix_random_seed
