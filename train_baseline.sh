...
sbatch --time=05:00:00  --gres=gpu:v100:4 --array=1-3%1 --job-name=pointrcnn-all-60-1_snowsim tools/scripts/compute_canada_train_eval_dense.sh --cfg_file tools/cfgs/dense_models/pointrcnn_train_all_60_1_snowsim.yaml -tcp_port 18860 --ckpt_save_interval 1 --fix_random_seed
sbatch --time=05:00:00  --gres=gpu:v100:4 --array=1-3%1 --job-name=pointrcnn-all-60-5_snowsim tools/scripts/compute_canada_train_eval_dense.sh --cfg_file tools/cfgs/dense_models/pointrcnn_train_all_60_5_snowsim.yaml -tcp_port 18870 --ckpt_save_interval 1 --fix_random_seed
