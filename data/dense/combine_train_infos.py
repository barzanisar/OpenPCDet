...
weather_splits = [f'{split_base_mode[0]}_clear_FOV3000_{split_base_mode[1]}.pkl', 
f'{split_base_mode[0]}_light_fog_FOV3000_{split_base_mode[1]}.pkl', 
...
for percent in percent_list:
    ...
    all_infos_path = root_path + f"/dense_infos_{split_base_mode[0]}_all_splits_FOV3000_{split_base_mode[1]}"
    ...
    print(f"For Percent {percent}, len all infos: {len(all_infos)}")
    if percent < 100:
