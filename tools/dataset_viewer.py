...
def convert_range_image_to_point_cloud(frame, range_images, camera_projections, range_image_top_pose, ri_index=(0, 1)):
    ...
    for c in calibrations:
        ...
        for cur_ri_index in ri_index:
            ...
            range_images_new, ri_indices, ri_ranges = range_image_utils.build_range_image_from_point_cloud(points_vehicle_frame= tf.expand_dims(points_tensor, axis=0),
                                       ...
                                       range_image_size=[range_image_cartesian.shape[0], range_image_cartesian.shape[1]],
                                       point_features=None,
                                       dtype=tf.float32,
                                       scope=None)
...
class WaymoDataset():
    def __init__(self, seq_file=None, simLidar=False):
        ...
        self.seq_dir = self.root_path / 'raw_data'# #TODO: 'domain_adaptation_0000'#
       ...
       for seq_path in self.seq_file_list:
           ...
           for cnt, data in enumerate(sequence_dataset):
               ...
               if self.simLidar:
                   ...
                   points, _, _, points_intensity, points_elongation = convert_range_image_to_point_cloud(frame, range_images, camera_projections, range_image_top_pose, ri_index=(0,1))
