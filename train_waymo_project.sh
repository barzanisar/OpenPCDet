...
# Test 
sbatch --time=04:00:00 --nodes=2 --ntasks=2 --array=1-2%1 --job-name=test-centerpoint-waymo tools/scripts/submit_ddp_compute_canada_waymo_multinode.sh --cfg_file tools/cfgs/waymo_models/centerpoint_1percent.yaml --tcp_port 18820 --test_only --workers 3 
sbatch --time=04:00:00 --nodes=2 --ntasks=2 --array=1-2%1 --job-name=test-centerpoint-clus-waymo tools/scripts/submit_ddp_compute_canada_waymo_multinode.sh --cfg_file tools/cfgs/waymo_models/centerpoint_clus_1percent.yaml --tcp_port 18840 --test_only --workers 3 --batch_size_per_gpu 4
...
# Test (In progress)
sbatch --time=04:00:00 --gres=gpu:t4:4 --mem=150G --nodes=2 --ntasks=2 --array=1-2%1 --job-name=test-pointrcnn-waymo tools/scripts/submit_ddp_compute_canada_waymo_multinode.sh --cfg_file tools/cfgs/waymo_models/pointrcnn_1percent.yaml --tcp_port 18810 --test_only --batch_size_per_gpu 4 --workers 3
sbatch --time=01:00:00 --gres=gpu:t4:4 --mem=150G --nodes=2 --ntasks=2 --array=1-1%1 --job-name=test-pointrcnn-clus-waymo tools/scripts/submit_ddp_compute_canada_waymo_multinode.sh --cfg_file tools/cfgs/waymo_models/pointrcnn_clus_1percent.yaml --tcp_port 18830 --test_only --batch_size_per_gpu 4 --workers 3
...
#Test:
sbatch --time=04:00:00 --nodes=2 --ntasks=2 --array=1-1%1 --job-name=test-pointrcnn_clus_finetune_100ep_lr0p003 tools/scripts/submit_ddp_compute_canada_waymo_multinode.sh --cfg_file tools/cfgs/waymo_models/pointrcnn_clus_finetune_100ep_lr0p003.yaml --tcp_port 18910 --test_only
sbatch --time=02:00:00 --nodes=2 --ntasks=2 --array=1-1%1 --job-name=test-pointrcnn_clus_finetune_200ep_lr0p003 tools/scripts/submit_ddp_compute_canada_waymo_multinode.sh --cfg_file tools/cfgs/waymo_models/pointrcnn_clus_finetune_200ep_lr0p003.yaml --tcp_port 18920 --test_only
sbatch --time=02:00:00 --nodes=2 --ntasks=2 --array=1-1%1 --job-name=test-pointrcnn_clus_finetune_200ep_lr0p01 tools/scripts/submit_ddp_compute_canada_waymo_multinode.sh --cfg_file tools/cfgs/waymo_models/pointrcnn_clus_finetune_200ep_lr0p01.yaml --tcp_port 18930 --test_only
sbatch --time=04:00:00 --nodes=2 --ntasks=2 --array=1-1%1 --job-name=test-pointrcnn_finetune_100ep_lr0p003 tools/scripts/submit_ddp_compute_canada_waymo_multinode.sh --cfg_file tools/cfgs/waymo_models/pointrcnn_finetune_100ep_lr0p003.yaml --tcp_port 18940 --test_only
sbatch --time=04:00:00 --nodes=2 --ntasks=2 --array=1-1%1 --job-name=test-pointrcnn_finetune_200ep_lr0p003 tools/scripts/submit_ddp_compute_canada_waymo_multinode.sh --cfg_file tools/cfgs/waymo_models/pointrcnn_finetune_200ep_lr0p003.yaml --tcp_port 18950 --test_only

sbatch --time=04:00:00 --nodes=2 --ntasks=2 --array=1-1%1 --job-name=test-pointrcnn_finetune_200ep_lr0p01 tools/scripts/submit_ddp_compute_canada_waymo_multinode.sh --cfg_file tools/cfgs/waymo_models/pointrcnn_finetune_200ep_lr0p01.yaml --tcp_port 18960 --test_only
