...
# 5 percent
# which is better without or with batches tracked? and run more tries of that
sbatch --time=8:00:00 --array=1-3%1 --job-name=nusc_scratch_"$WAYMO_EPOCH_2"ep_try$TRY tools/scripts/submit_ddp_${CLUSTER_NAME}_frozen_waymo.sh --cfg_file tools/cfgs/nuscenes_models/pointrcnn_minkunet_1sweeps_sampled_20_all_class.yaml --mode scratch --tcp_port 16929 --extra_tag scratch_t$TRY --num_epochs_1 $WAYMO_EPOCH_2 --test_start_epoch 0 --wandb_run_name scratch_minkunet_pointrcnn --wandb_group ep"$WAYMO_EPOCH_2"_try$TRY

sbatch --time=8:00:00 --array=1-3%1 --job-name=nusc_seg_"$WAYMO_EPOCH_1"ep_"$WAYMO_EPOCH_2"ep_try$TRY tools/scripts/submit_ddp_${CLUSTER_NAME}_frozen_waymo.sh --cfg_file tools/cfgs/nuscenes_models/pointrcnn_minkunet_1sweeps_sampled_20_all_class.yaml --tcp_port 16930 --extra_tag segcontrast_t$TRY --pretrained_model_1 /OpenPCDet/checkpoints/seg_ep199.pth.tar --num_epochs_1 $WAYMO_EPOCH_1 --pretrained_model_2 /OpenPCDet/output/nuscenes_models/pointrcnn_minkunet_1sweeps_sampled_20_all_class/segcontrast_t"$TRY"_ep"$WAYMO_EPOCH_1"_frozen_bb/ckpt/checkpoint_epoch_$WAYMO_EPOCH_1.pth --num_epochs_2 $WAYMO_EPOCH_2 --test_start_epoch 0 --wandb_run_name segcontrast_10perc_waymo_minkunet --wandb_group ep"$WAYMO_EPOCH_1"_ep"$WAYMO_EPOCH_2"_try$TRY

sbatch --time=8:00:00 --array=1-3%1 --job-name=nusc_seglidarplusdet_"$WAYMO_EPOCH_1"ep_"$WAYMO_EPOCH_2"ep_try$TRY tools/scripts/submit_ddp_${CLUSTER_NAME}_frozen_waymo.sh --cfg_file tools/cfgs/nuscenes_models/pointrcnn_minkunet_1sweeps_sampled_20_all_class.yaml --tcp_port 16931 --extra_tag segcontrast_lidarplusdet_t$TRY --pretrained_model_1 /OpenPCDet/checkpoints/seg_lidar_plus_det_ep199_t2.pth.tar --num_epochs_1 $WAYMO_EPOCH_1 --pretrained_model_2 /OpenPCDet/output/nuscenes_models/pointrcnn_minkunet_1sweeps_sampled_20_all_class/segcontrast_lidarplusdet_t"$TRY"_ep"$WAYMO_EPOCH_1"_frozen_bb/ckpt/checkpoint_epoch_$WAYMO_EPOCH_1.pth --num_epochs_2 $WAYMO_EPOCH_2 --test_start_epoch 0 --wandb_run_name segcontrast_lidarplusdet_10perc_waymo_minkunet --wandb_group ep"$WAYMO_EPOCH_1"_ep"$WAYMO_EPOCH_2"_try$TRY

sbatch --time=8:00:00 --array=1-3%1 --job-name=nusc_segonlydet_"$WAYMO_EPOCH_1"ep_"$WAYMO_EPOCH_2"ep_try$TRY tools/scripts/submit_ddp_${CLUSTER_NAME}_frozen_waymo.sh --cfg_file tools/cfgs/nuscenes_models/pointrcnn_minkunet_1sweeps_sampled_20_all_class.yaml --tcp_port 16932 --extra_tag segcontrast_onlydet_t$TRY --pretrained_model_1 /OpenPCDet/checkpoints/seg_only_det_ep199_t2.pth.tar --num_epochs_1 $WAYMO_EPOCH_1 --pretrained_model_2 /OpenPCDet/output/nuscenes_models/pointrcnn_minkunet_1sweeps_sampled_20_all_class/segcontrast_onlydet_t"$TRY"_ep"$WAYMO_EPOCH_1"_frozen_bb/ckpt/checkpoint_epoch_$WAYMO_EPOCH_1.pth --num_epochs_2 $WAYMO_EPOCH_2 --test_start_epoch 0 --wandb_run_name segcontrast_det_10perc_waymo_minkunet --wandb_group ep"$WAYMO_EPOCH_1"_ep"$WAYMO_EPOCH_2"_try$TRY 
