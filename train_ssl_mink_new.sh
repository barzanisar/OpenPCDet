...
#################### 80 epochs #########################################
## scratch
sbatch --time=10:00:00 --array=1-5%1 --job-name=car-scratch-80ep-scene100 tools/scripts/submit_ddp_$CLUSTER_NAME.sh --cfg_file tools/cfgs/waymo_models/pointrcnn_minkunet_80ep_scene_sampled_100.yaml --tcp_port 18910 --extra_tag scratch_car --test_start_epoch 70
sbatch --time=10:00:00 --array=1-5%1 --job-name=car-scratch-80ep-scene100_t2 tools/scripts/submit_ddp_$CLUSTER_NAME.sh --cfg_file tools/cfgs/waymo_models/pointrcnn_minkunet_80ep_scene_sampled_100.yaml --tcp_port 18910 --extra_tag scratch_car_t2 --test_start_epoch 70
sbatch --time=10:00:00 --array=1-5%1 --job-name=segcar-78ep-scene100 tools/scripts/submit_ddp_$CLUSTER_NAME.sh --cfg_file tools/cfgs/waymo_models/pointrcnn_minkunet_78ep_scene_sampled_100.yaml --tcp_port 18915 --extra_tag segcontrast_car --pretrained_model /OpenPCDet/checkpoints/seg_ep49.pth.tar --test_start_epoch 68
sbatch --time=10:00:00 --array=1-5%1 --job-name=segcar-78ep-scene100_t2 tools/scripts/submit_ddp_$CLUSTER_NAME.sh --cfg_file tools/cfgs/waymo_models/pointrcnn_minkunet_78ep_scene_sampled_100.yaml --tcp_port 18915 --extra_tag segcontrast_car_t2 --pretrained_model /OpenPCDet/checkpoints/seg_ep49.pth.tar --test_start_epoch 68

sbatch --time=10:00:00 --array=1-5%1 --job-name=segdetcar-78ep-scene100 tools/scripts/submit_ddp_$CLUSTER_NAME.sh --cfg_file tools/cfgs/waymo_models/pointrcnn_minkunet_78ep_scene_sampled_100.yaml --tcp_port 18915 --extra_tag segcontrast_plus_dethead_0p8w_car --pretrained_model /OpenPCDet/checkpoints/seg_plus_det0p8_ep49.pth.tar --test_start_epoch 68
sbatch --time=10:00:00 --array=1-5%1 --job-name=segdetcar-78ep-scene100_t2 tools/scripts/submit_ddp_$CLUSTER_NAME.sh --cfg_file tools/cfgs/waymo_models/pointrcnn_minkunet_78ep_scene_sampled_100.yaml --tcp_port 18915 --extra_tag segcontrast_plus_dethead_0p8w_car_t2 --pretrained_model /OpenPCDet/checkpoints/seg_plus_det0p8_ep49.pth.tar --test_start_epoch 68
...
## finetune seg
sbatch --time=10:00:00 --array=1-3%1 --job-name=segcar-28ep-scene100 tools/scripts/submit_ddp_$CLUSTER_NAME.sh --cfg_file tools/cfgs/waymo_models/pointrcnn_minkunet_28ep_scene_sampled_100.yaml --tcp_port 18412 --extra_tag segcontrast_car --pretrained_model /OpenPCDet/checkpoints/seg_ep49.pth.tar --test_start_epoch 18
sbatch --time=10:00:00 --array=1-3%1 --job-name=segcar-28ep-scene100_t2 tools/scripts/submit_ddp_$CLUSTER_NAME.sh --cfg_file tools/cfgs/waymo_models/pointrcnn_minkunet_28ep_scene_sampled_100.yaml --tcp_port 18413 --extra_tag segcontrast_car_t2 --pretrained_model /OpenPCDet/checkpoints/seg_ep49.pth.tar --test_start_epoch 18

sbatch --time=10:00:00 --array=1-3%1 --job-name=segdetcar-28ep-scene100 tools/scripts/submit_ddp_$CLUSTER_NAME.sh --cfg_file tools/cfgs/waymo_models/pointrcnn_minkunet_28ep_scene_sampled_100.yaml --tcp_port 18412 --extra_tag segcontrast_plus_dethead_0p8w_car --pretrained_model /OpenPCDet/checkpoints/seg_plus_det0p8_ep49.pth.tar --test_start_epoch 18
sbatch --time=10:00:00 --array=1-3%1 --job-name=segdetcar-28ep-scene100_t2 tools/scripts/submit_ddp_$CLUSTER_NAME.sh --cfg_file tools/cfgs/waymo_models/pointrcnn_minkunet_28ep_scene_sampled_100.yaml --tcp_port 18413 --extra_tag segcontrast_plus_dethead_0p8w_car_t2 --pretrained_model /OpenPCDet/checkpoints/seg_plus_det0p8_ep49.pth.tar --test_start_epoch 18
...
sbatch --time=10:00:00 --array=1-3%1 --job-name=car-scratch-30ep-scene20 tools/scripts/submit_ddp_$CLUSTER_NAME.sh --cfg_file tools/cfgs/waymo_models/pointrcnn_minkunet_30ep_scene_sampled_20.yaml --tcp_port 17910 --extra_tag scratch_car --test_start_epoch 20
sbatch --time=10:00:00 --array=1-3%1 --job-name=car-scratch-30ep-scene20_t2 tools/scripts/submit_ddp_$CLUSTER_NAME.sh --cfg_file tools/cfgs/waymo_models/pointrcnn_minkunet_30ep_scene_sampled_20.yaml --tcp_port 17911 --extra_tag scratch_car_t2 --test_start_epoch 20
sbatch --time=10:00:00 --array=1-3%1 --job-name=segcar-28ep-scene20 tools/scripts/submit_ddp_$CLUSTER_NAME.sh --cfg_file tools/cfgs/waymo_models/pointrcnn_minkunet_28ep_scene_sampled_20.yaml --tcp_port 18412 --extra_tag segcontrast_car --pretrained_model /OpenPCDet/checkpoints/seg_ep49.pth.tar --test_start_epoch 18
sbatch --time=10:00:00 --array=1-3%1 --job-name=segcar-28ep-scene20_t2 tools/scripts/submit_ddp_$CLUSTER_NAME.sh --cfg_file tools/cfgs/waymo_models/pointrcnn_minkunet_28ep_scene_sampled_20.yaml --tcp_port 18413 --extra_tag segcontrast_car_t2 --pretrained_model /OpenPCDet/checkpoints/seg_ep49.pth.tar --test_start_epoch 18
sbatch --time=10:00:00 --array=1-3%1 --job-name=segdetcar-28ep-scene20 tools/scripts/submit_ddp_$CLUSTER_NAME.sh --cfg_file tools/cfgs/waymo_models/pointrcnn_minkunet_28ep_scene_sampled_20.yaml --tcp_port 18412 --extra_tag segcontrast_plus_dethead_0p8w_car --pretrained_model /OpenPCDet/checkpoints/seg_plus_det0p8_ep49.pth.tar --test_start_epoch 18
sbatch --time=10:00:00 --array=1-3%1 --job-name=segdetcar-28ep-scene20_t2 tools/scripts/submit_ddp_$CLUSTER_NAME.sh --cfg_file tools/cfgs/waymo_models/pointrcnn_minkunet_28ep_scene_sampled_20.yaml --tcp_port 18413 --extra_tag segcontrast_plus_dethead_0p8w_car_t2 --pretrained_model /OpenPCDet/checkpoints/seg_plus_det0p8_ep49.pth.tar --test_start_epoch 18

########################## nuscenes sampled 100 i.e. 1%  #########################################
### 30, 80, 200 epochs
sbatch --time=10:00:00 --array=1-3%1 --job-name=30ep-nus-scratch-1perc tools/scripts/submit_ddp_$CLUSTER_NAME.sh --cfg_file tools/cfgs/nuscenes_models/pointrcnn_minkunet_30ep_1sweeps_sampled_100.yaml --tcp_port 16911 --extra_tag scratch_car --test_start_epoch 20
sbatch --time=10:00:00 --array=1-3%1 --job-name=t2_30ep-nus-scratch-1perc tools/scripts/submit_ddp_$CLUSTER_NAME.sh --cfg_file tools/cfgs/nuscenes_models/pointrcnn_minkunet_30ep_1sweeps_sampled_100.yaml --tcp_port 16912 --extra_tag scratch_car_t2 --test_start_epoch 20
sbatch --time=10:00:00 --array=1-3%1 --job-name=30ep-nus-seg-1perc tools/scripts/submit_ddp_$CLUSTER_NAME.sh --cfg_file tools/cfgs/nuscenes_models/pointrcnn_minkunet_30ep_1sweeps_sampled_100.yaml --tcp_port 16911 --extra_tag segcontrast_car --pretrained_model /OpenPCDet/checkpoints/seg_ep49.pth.tar --test_start_epoch 18
sbatch --time=10:00:00 --array=1-3%1 --job-name=t2_30ep-nus-seg-1perc tools/scripts/submit_ddp_$CLUSTER_NAME.sh --cfg_file tools/cfgs/nuscenes_models/pointrcnn_minkunet_30ep_1sweeps_sampled_100.yaml --tcp_port 16912 --extra_tag segcontrast_car_t2 --pretrained_model /OpenPCDet/checkpoints/seg_ep49.pth.tar --test_start_epoch 18
sbatch --time=10:00:00 --array=1-3%1 --job-name=30ep-nus-segdet-1perc tools/scripts/submit_ddp_$CLUSTER_NAME.sh --cfg_file tools/cfgs/nuscenes_models/pointrcnn_minkunet_30ep_1sweeps_sampled_100.yaml --tcp_port 16911 --extra_tag segcontrast_plus_dethead_car --pretrained_model /OpenPCDet/checkpoints/seg_plus_det_nusc_ep49.pth.tar --test_start_epoch 18
sbatch --time=10:00:00 --array=1-3%1 --job-name=t2_30ep-nus-segdet-1perc tools/scripts/submit_ddp_$CLUSTER_NAME.sh --cfg_file tools/cfgs/nuscenes_models/pointrcnn_minkunet_30ep_1sweeps_sampled_100.yaml --tcp_port 16912 --extra_tag segcontrast_plus_dethead_car_t2 --pretrained_model /OpenPCDet/checkpoints/seg_plus_det_nusc_ep49.pth.tar --test_start_epoch 18

sbatch --time=10:00:00 --array=1-3%1 --job-name=30ep-nus-scratch-5perc tools/scripts/submit_ddp_$CLUSTER_NAME.sh --cfg_file tools/cfgs/nuscenes_models/pointrcnn_minkunet_30ep_1sweeps_sampled_20.yaml --tcp_port 16911 --extra_tag scratch_car --test_start_epoch 20
sbatch --time=10:00:00 --array=1-3%1 --job-name=t2_30ep-nus-scratch-5perc tools/scripts/submit_ddp_$CLUSTER_NAME.sh --cfg_file tools/cfgs/nuscenes_models/pointrcnn_minkunet_30ep_1sweeps_sampled_20.yaml --tcp_port 16912 --extra_tag scratch_car_t2 --test_start_epoch 20
sbatch --time=10:00:00 --array=1-3%1 --job-name=30ep-nus-seg-1perc tools/scripts/submit_ddp_$CLUSTER_NAME.sh --cfg_file tools/cfgs/nuscenes_models/pointrcnn_minkunet_30ep_1sweeps_sampled_20.yaml --tcp_port 16911 --extra_tag segcontrast_car --pretrained_model /OpenPCDet/checkpoints/seg_ep49.pth.tar --test_start_epoch 18
sbatch --time=10:00:00 --array=1-3%1 --job-name=t2_30ep-nus-seg-1perc tools/scripts/submit_ddp_$CLUSTER_NAME.sh --cfg_file tools/cfgs/nuscenes_models/pointrcnn_minkunet_30ep_1sweeps_sampled_20.yaml --tcp_port 16912 --extra_tag segcontrast_car_t2 --pretrained_model /OpenPCDet/checkpoints/seg_ep49.pth.tar --test_start_epoch 18
sbatch --time=10:00:00 --array=1-3%1 --job-name=30ep-nus-segdet-5perc tools/scripts/submit_ddp_$CLUSTER_NAME.sh --cfg_file tools/cfgs/nuscenes_models/pointrcnn_minkunet_30ep_1sweeps_sampled_20.yaml --tcp_port 16911 --extra_tag segcontrast_plus_dethead_car --pretrained_model /OpenPCDet/checkpoints/seg_plus_det_nusc_ep49.pth.tar --test_start_epoch 18
sbatch --time=10:00:00 --array=1-3%1 --job-name=t2_30ep-nus-segdet-5perc tools/scripts/submit_ddp_$CLUSTER_NAME.sh --cfg_file tools/cfgs/nuscenes_models/pointrcnn_minkunet_30ep_1sweeps_sampled_20.yaml --tcp_port 16912 --extra_tag segcontrast_plus_dethead_car_t2 --pretrained_model /OpenPCDet/checkpoints/seg_plus_det_nusc_ep49.pth.tar --test_start_epoch 18
...
# tools/scripts/submit_ddp_turing.sh --num_gpus 2 --cuda_visible_devices 0,1 --tcp_port 19835 --cfg_file tools/cfgs/waymo_models/pointrcnn_minkunet_30ep_scene_sampled_100_bn_ignored.yaml --extra_tag segcontrast_plus_dethead_0p8w --pretrained_model /OpenPCDet/checkpoints/seg_plus_det0p8_ep49.pth.tar > ./output/log/segdet_30ep_waymo1perc_bn_ignored_$(date +%Y-%m-%d_%H:%M).out 2>&1
...
# tools/scripts/submit_ddp_turing_debug.sh
# python /OpenPCDet/tools/train.py --cfg_file /OpenPCDet/tools/cfgs/waymo_models/pointrcnn_minkunet_30ep_scene_sampled_100_run_mv_ignored.yaml --pretrained_model /OpenPCDet/checkpoints/seg_plus_det0p8_ep49.pth.tar --fix_random_seed --batch_size 4 --workers 8  --extra_tag segcontrast_plus_dethead_0p8w
