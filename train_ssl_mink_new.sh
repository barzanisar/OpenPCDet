...
## finetune seg 
sbatch --time=10:00:00 --array=1-3%1 --job-name=det-segdet0p8-25ep-scene100 tools/scripts/submit_ddp_$CLUSTER_NAME.sh --cfg_file tools/cfgs/waymo_models/pointrcnn_minkunet_25ep_scene_sampled_100.yaml --tcp_port 18411 --extra_tag segcontrast_plus_dethead_0p8w --pretrained_model /OpenPCDet/checkpoints/seg_plus_det0p8_ep49.pth.tar
...
sbatch --time=10:00:00 --array=1-5%1 --job-name=det-segdet0p8-75ep-scene100 tools/scripts/submit_ddp_$CLUSTER_NAME.sh --cfg_file tools/cfgs/waymo_models/pointrcnn_minkunet_75ep_scene_sampled_100.yaml --tcp_port 18414 --extra_tag segcontrast_plus_dethead_0p8w --pretrained_model /OpenPCDet/checkpoints/seg_plus_det0p8_ep49.pth.tar
